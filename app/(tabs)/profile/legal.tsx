...
import { Card, Callout, TopAppBar } from '../../../components';

export default function LegalScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <TopAppBar title="Legal & Compliance" />
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card style={styles.card}>
          <Text style={[textStyles.cardTitle, styles.sectionTitle]}>Terms of Service</Text>
        ...
        <Card style={styles.card}>
          <Text style={[textStyles.cardTitle, styles.sectionTitle]}>Privacy Policy</Text>
          <Text style={[textStyles.body, styles.paragraph]}>
        ...
        <Card style={styles.card}>
          <Text style={[textStyles.cardTitle, styles.sectionTitle]}>Data Processing Consent</Text>
          <Text style={[textStyles.body, styles.paragraph]}>
...
const styles = StyleSheet.create({
  ...
  paragraph: { color: colors.inkSoft, lineHeight: 24 },
});
